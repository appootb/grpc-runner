...
RUN go get github.com/golang/protobuf/protoc-gen-go@v1.4.2 && \
	...
	go get github.com/appootb/grpc-gen/protoc-gen-auth@v1.0 && \
	go get github.com/appootb/grpc-gen/protoc-gen-markdown@v1.0 && \
	go get github.com/appootb/grpc-gen/protoc-gen-dart-export@v1.0
